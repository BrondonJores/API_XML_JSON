    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Colonne À propos */}
          <div>
            <h3 className="text-white text-lg font-semibold mb-4">About FoodApp</h3>
            <p className="text-sm leading-relaxed">
              Votre destination culinaire en ligne. Découvrez une large sélection de plats délicieux,
              commandez facilement et profitez d'une livraison rapide à votre porte.
            </p>
            <div className="mt-4">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/menu" className="text-sm hover:text-indigo-400 transition-colors">
                  Menu
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/converter" className="text-sm hover:text-indigo-400 transition-colors">
                  Converter
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-sm">123 Food Street, Paris, France</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 mr-2 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href="mailto:contact@foodapp.com" className="text-sm hover:text-indigo-400 transition-colors">
                  contact@foodapp.com
                </a>
              </li>
              <li className="flex items-start">
                ...
                <a href="tel:+33123456789" className="text-sm hover:text-indigo-400 transition-colors">
                  +33 1 23 45 67 89
                </a>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-sm text-gray-400">
            &copy; {currentYear} FoodApp. Tous droits réservés.
          </p>
        </div>
      </div>
    </footer>
